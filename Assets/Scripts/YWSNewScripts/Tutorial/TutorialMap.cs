...
public class TutorialMap : SingletonMonoBehaviour<TutorialMap>
{
    ...
    private IEnumerator PieceReverse(bool isSkill)
    {
        foreach (GameObject piece in _reversePiece)
        {
            switch (isSkill)
            {
                case true:
                    ...
                    {
                        TutorialDirector.Instance.AddScore(true, TutorialDirector.Instance.point);
                    }
                    else
                    {
                        TutorialDirector.Instance.AddScore(false, TutorialDirector.Instance.point);
                    }
                ...
                case false:
                    ...
                    {
                        TutorialDirector.Instance.AddScore(true, TutorialDirector.Instance.point);
                        TutorialDirector.Instance.AddReversedCount(true);
                    }
                    else
                    {
                        TutorialDirector.Instance.AddScore(false, TutorialDirector.Instance.point);
                        TutorialDirector.Instance.AddReversedCount(false);
                    }
        ...
        if (isSkillActivate)
        {
            TutorialDirector.Instance.intervalTime = 1f;
            TutorialDirector.Instance.gameState = TutorialDirector.GameState.interval;
            TutorialDirector.Instance.nextStateCue = TutorialDirector.GameState.preActive;
        ...
        {
            TutorialDirector.Instance.intervalTime = 0.5f;
            TutorialDirector.Instance.gameState = TutorialDirector.GameState.interval;
            TutorialDirector.Instance.nextStateCue = TutorialDirector.GameState.reversed;
            _isSecondCheck = false;
        }
        else
    ...
    public bool CheckEnd()
    {
        ...
        if (isEnd)
        {
            TutorialDirector.Instance.AddPreScore(true, TutorialDirector.Instance.point * blackCount);
            TutorialDirector.Instance.AddPreScore(false, TutorialDirector.Instance.point * whiteCount);
        }
    ...
    public void CheckMap()
    {
        ...
        TutorialDirector.Instance.AddPieceCount(blackCount, whiteCount);
    }
